...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "cython_insertion",
        "sources": [
            "cython_insertion.pyx"
        ]
    },
    "module_name": "cython_insertion"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_insertion
#define __PYX_HAVE_API__cython_insertion
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
/* Module declarations from 'cython_insertion' */
...
static PyObject *__pyx_f_16cython_insertion_sort(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_16cython_insertion_check_method_time(int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "cython_insertion"
extern int __pyx_module_is_main_cython_insertion;
int __pyx_module_is_main_cython_insertion = 0;

/* Implementation of 'cython_insertion' */
...
static const char __pyx_k_1f_ns_1f_ns[] = "{:.1f} ns +/ - {:.1f}ns";
...
static PyObject *__pyx_kp_u_1f_ns_1f_ns;
...
static PyObject *__pyx_pf_16cython_insertion_sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_t); /* proto */
static PyObject *__pyx_pf_16cython_insertion_2check_method_time(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
...
static PyObject *__pyx_pw_16cython_insertion_1sort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_16cython_insertion_sort(__Pyx_memviewslice __pyx_v_arr, CYTHON_UNUSED int __pyx_v_t, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_tempVal;
 ...
 */
    ...
    __pyx_v_tempVal = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) )));

    /* "cython_insertion.pyx":12
 *     for i in range (0, len(arr)):
 *         tempVal = arr[i]
 *         j = i - 1             # <<<<<<<<<<<<<<
 *         while j >= 0 and arr[j] > tempVal:
 ...
 */
    while (1) {
      ...
      __pyx_t_4 = __pyx_v_j;
      if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_arr.shape[0];
      __pyx_t_6 = (((*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) ))) > __pyx_v_tempVal) != 0);
      __pyx_t_5 = __pyx_t_6;
      __pyx_L7_bool_binop_done:;
      if (!__pyx_t_5) break;

      /* "cython_insertion.pyx":14
 *         j = i - 1
 *         while j >= 0 and arr[j] > tempVal:
 *             arr[j + 1] = arr[j]             # <<<<<<<<<<<<<<
 *             j = j - 1
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_7 * __pyx_v_arr.strides[0]) )) = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) )));

      /* "cython_insertion.pyx":15
 *         while j >= 0 and arr[j] > tempVal:
 *             arr[j + 1] = arr[j]
 *             j = j - 1             # <<<<<<<<<<<<<<
 *         arr [j + 1] = tempVal
 ...
 */
    ...
    if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_arr.shape[0];
    *((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) )) = __pyx_v_tempVal;
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_16cython_insertion_1sort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_16cython_insertion_1sort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_arr,&__pyx_n_s_t,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_t)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("sort", 1, 2, 2, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "sort") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_t = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_t == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("sort", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_insertion.sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_16cython_insertion_sort(__pyx_self, __pyx_v_arr, __pyx_v_t);
...
static PyObject *__pyx_pf_16cython_insertion_sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_t) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_16cython_insertion_sort(__pyx_v_arr, __pyx_v_t, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static PyObject *__pyx_pw_16cython_insertion_3check_method_time(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_16cython_insertion_check_method_time(CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  int __pyx_v_count;
  float __pyx_v_st;
  float __pyx_v_sst;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("check_method_time", 0);

  /* "cython_insertion.pyx":20
 * 
 * cpdef check_method_time():
 *     cdef int n = 1000             # <<<<<<<<<<<<<<
 *     cdef int count = 10000
 ...
 *     cdef float sst = 0.0
 */
  __pyx_v_count = 0x2710;

  /* "cython_insertion.pyx":22
 *     cdef int n = 1000
 *     cdef int count = 10000
 *     cdef float st = 0.0             # <<<<<<<<<<<<<<
 *     cdef float sst = 0.0
 ...
 * 
 */
  __pyx_t_1 = PyList_New(9); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  PyList_SET_ITEM(__pyx_t_1, 2, __pyx_int_14);
  ...
  PyList_SET_ITEM(__pyx_t_1, 5, __pyx_int_50);
  __Pyx_INCREF(__pyx_int_75);
  __Pyx_GIVEREF(__pyx_int_75);
  PyList_SET_ITEM(__pyx_t_1, 6, __pyx_int_75);
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_arrs = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "cython_insertion.pyx":30
 *     cdef int j
 *     cdef array.array arrs = array.array('i',[10, 22, 14, 4, 2, 50, 75, 49, 4])
 *     cdef int[:] arr = arrs             # <<<<<<<<<<<<<<
 * 
 *     for j in range ( n):
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(((PyObject *)__pyx_v_arrs), PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 30, __pyx_L1_error)
  __pyx_v_arr = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "cython_insertion.pyx":32
 *     cdef int[:] arr = arrs
 * 
 *     for j in range ( n):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_perf_counter_ns); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 33, __pyx_L1_error)
    ...
    __pyx_t_8 = __pyx_PyFloat_AsFloat(__pyx_t_1); if (unlikely((__pyx_t_8 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_start = __pyx_t_8;

    /* "cython_insertion.pyx":34
 *     for j in range ( n):
 *         start = time.perf_counter_ns ()
 *         for i in range ( count ):             # <<<<<<<<<<<<<<
 *             sort(arr, i)
 ...
 *         ns = ( stop - start ) / count
 */
      __pyx_t_1 = __pyx_f_16cython_insertion_sort(__pyx_v_arr, __pyx_v_i, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    }

    /* "cython_insertion.pyx":36
 *         for i in range ( count ):
 *             sort(arr, i)
 *         stop = time.perf_counter_ns ()             # <<<<<<<<<<<<<<
 *         ns = ( stop - start ) / count
 *         st += ns
 */
    __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_n_s_time); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_perf_counter_ns); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 36, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = NULL;
 ...
 *         sst += ns * ns
 */
    __pyx_t_8 = (__pyx_v_stop - __pyx_v_start);
    if (unlikely(__pyx_v_count == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 37, __pyx_L1_error)
    }
    __pyx_v_ns = (__pyx_t_8 / ((float)__pyx_v_count));

    /* "cython_insertion.pyx":38
 *         stop = time.perf_counter_ns ()
 *         ns = ( stop - start ) / count
 *         st += ns             # <<<<<<<<<<<<<<
 *         sst += ns * ns
 * 
 */
    __pyx_v_st = (__pyx_v_st + __pyx_v_ns);

    /* "cython_insertion.pyx":39
 *         ns = ( stop - start ) / count
 *         st += ns
 *         sst += ns * ns             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_sst = (__pyx_v_sst + (__pyx_v_ns * __pyx_v_ns));
  }

  /* "cython_insertion.pyx":41
 *         sst += ns * ns
 * 
 *     cdef float mean = st /n             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_mean = (__pyx_v_st / ((float)__pyx_v_n));

  /* "cython_insertion.pyx":42
 * 
 *     cdef float mean = st /n
 *     cdef float sdev = sqrt(( sst - mean * mean * n) /(( n -1) ))             # <<<<<<<<<<<<<<
 *     print ("{:.1f} ns +/ - {:.1f}ns".format(mean, sdev ))
 */
  __pyx_t_8 = (__pyx_v_sst - ((__pyx_v_mean * __pyx_v_mean) * __pyx_v_n));
  __pyx_t_12 = (__pyx_v_n - 1);
  if (unlikely(__pyx_t_12 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 42, __pyx_L1_error)
  }
  __pyx_v_sdev = sqrt((__pyx_t_8 / ((float)__pyx_t_12)));

  /* "cython_insertion.pyx":43
 *     cdef float mean = st /n
 *     cdef float sdev = sqrt(( sst - mean * mean * n) /(( n -1) ))
 *     print ("{:.1f} ns +/ - {:.1f}ns".format(mean, sdev ))             # <<<<<<<<<<<<<<
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_u_1f_ns_1f_ns, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_7 = PyFloat_FromDouble(__pyx_v_mean); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_13 = PyFloat_FromDouble(__pyx_v_sdev); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 43, __pyx_L1_error)
  ...
  #endif
  {
    __pyx_t_15 = PyTuple_New(2+__pyx_t_4); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 43, __pyx_L1_error)
    ...
    PyTuple_SET_ITEM(__pyx_t_15, 1+__pyx_t_4, __pyx_t_13);
    __pyx_t_7 = 0;
    __pyx_t_13 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("cython_insertion.check_method_time", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF((PyObject *)__pyx_v_arrs);
  __PYX_XDEC_MEMVIEW(&__pyx_v_arr, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_16cython_insertion_3check_method_time(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_16cython_insertion_3check_method_time(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("check_method_time (wrapper)", 0);
  __pyx_r = __pyx_pf_16cython_insertion_2check_method_time(__pyx_self);
...
static PyObject *__pyx_pf_16cython_insertion_2check_method_time(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("check_method_time", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_16cython_insertion_check_method_time(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cython_insertion.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_insertion.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cython_insertion._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"sort", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_16cython_insertion_1sort, METH_VARARGS|METH_KEYWORDS, 0},
  {"check_method_time", (PyCFunction)__pyx_pw_16cython_insertion_3check_method_time, METH_NOARGS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cython_insertion(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_insertion},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_u_1f_ns_1f_ns, __pyx_k_1f_ns_1f_ns, sizeof(__pyx_k_1f_ns_1f_ns), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_insertion(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_insertion(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cython_insertion(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cython_insertion(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cython_insertion(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cython_insertion' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_insertion(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_insertion", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_insertion) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_insertion")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_insertion", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_insertion", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_insertion");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
